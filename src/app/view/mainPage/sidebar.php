<div class="pt-3">
    <div>
        <h4 class="border-bottom pb-2 mx-3">Elérhetőség</h4>
        <div class="mb-3 mx-3">
    ...
    <div>
        <h4 class="border-bottom pb-2 mx-3">Találatok szűrése</h4>
        <form>
            <div class="mb-3 mx-3">
                <label for="artist" class="h6">Előadó: </label>
                <input type="text" name="artist" id="artist" class="form-control" placeholder="Írd be az előadó nevét.. ">
            </div>
            <hr>
            <div class="mb-3 mx-3">
                <label for="album" class="h6">Album: </label>
                <input type="text" name="album" id="album" class="form-control" placeholder="Írd be az album címét.. ">
            </div>
            <hr>
            <div class="mb-3 mx-3">
                <label for="selectFormat" class="h6">Formátum: </label>
                <select name="selectFormat" id="selectFormat" class="form-select" onchange="userToTable();">
            ...
            <div class="mb-3 mx-3">
                ...
                <select name="selectCategory" id="selectCategory" class="form-select" onchange="userToTable();">
