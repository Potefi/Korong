<div class="container text-center vertical-align">
    ...
    <div class="d-none d-md-flex row bg-white shadow rounded-bottom my-5">
    ...
    <div class="d-none d-md-flex row bg-white rounded-bottom shadow my-5">
        <div class="col-12 pt-2">
            <h2 class="display-6 mt-2">Írj nekünk!</h2>
        </div>
